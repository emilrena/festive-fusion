...
class ForgotPassMehandi extends StatefulWidget {
  const ForgotPassMehandi({Key? key}) : super(key: key);

  @override
  State<ForgotPassMehandi> createState() => _ForgotPassMehandiState();
}

class _ForgotPassMehandiState extends State<ForgotPassMehandi> {
                ...
                if (cpassword.text == password.text) {
                  ...
                  if (querySnapshot.docs.isNotEmpty) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Login(type: "mehandi"),
                      ),
                    );
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
