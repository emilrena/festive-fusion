...
class AdminRentalView extends StatefulWidget {
  const AdminRentalView({Key? key}) : super(key: key);

  @override
  State<AdminRentalView> createState() =>
      _AdminRentalViewState();
}

class _AdminRentalViewState
    extends State<AdminRentalView> {
