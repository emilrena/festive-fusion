...
class RentalProceed extends StatefulWidget {
  const RentalProceed({Key? key}) : super(key: key);

  @override
  State<RentalProceed> createState() => _RentalProceedState();
}

class _RentalProceedState extends State<RentalProceed> {
  @override
