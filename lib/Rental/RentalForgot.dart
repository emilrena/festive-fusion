...
class ForgotPassRental extends StatefulWidget {
  const ForgotPassRental({Key? key}) : super(key: key);

  @override
  State<ForgotPassRental> createState() => _ForgotPassRentalState();
}

class _ForgotPassRentalState extends State<ForgotPassRental> {
